...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    driveSubsystem.setDefaultCommand(
            new RunCommand(
                    () -> {
                      driveSubsystem.drive(driveController.getLeftY(),
  ...
  public Command getAutonomousCommand() {
    ...
    return new SequentialCommandGroup(
      DriveCommands.drive(driveSubsystem, 0.8, 0.8).withTimeout(0.5),
      LauncherCommands.spinLauncher(launchSubsystem).withTimeout(1),
      IntakeCommands.intakeToggle(intakeSubsystem).withTimeout(1)
  );
  }
}